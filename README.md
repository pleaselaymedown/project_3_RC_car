...
│   │   ├── main.h                   # 공통 헤더 및 기본 설정
│   │   ├── motor.h                  # 모터 방향 enum 및 제어 함수 선언
│   │   ├── bluetooth.h              # 블루투스 초기화 함수 선언
│   │   ├── ultrasonic.h             # 초음파 센서 핀 정의 및 Trigger 함수 선언
│   │   ├── delay.h                  # us 단위 지연 함수 선언
│   │   ├── tim.h                    # TIM3, TIM10, TIM11 설정 헤더
│   │   ├── usart.h                  # USART1, USART2 설정 헤더
│   │   └── gpio.h                   # GPIO 설정 헤더
│   │
...
<img src="./images/rc_car_front.jpg" width="300">    <img src="./images/rc_car_side.jpg" width="300">

### 전면 / 측면

<img src="./images/rc_car_top.jpg" width="300">    <img src="./images/rc_car_sensor.jpg" width="300">
...
현재 상태를 기준으로 다음 상태를 결정하도록 만들어 주행 흐름을 명확하게 분리했습니다.
...
* 초음파 Trigger용 마이크로초 지연 타이머를 모터 PWM 타이머와 분리하여 PWM 간섭 가능성 감소
* 블루투스 앱 UI를 제작하여 문자 명령 대신 버튼 기반 제어 구현
* 주행 속도값을 고정값이 아니라 블루투스 명령으로 단계별 조절 가능하도록 확장
* 초음파 센서값에 이동평균 필터를 적용하여 거리 측정 안정성 향상
* 배터리 전압 측정 기능을 추가하여 저전압 상태를 사용자에게 알림
* 자율주행 중 장애물 회피 방향과 센서값을 LCD 또는 OLED에 표시
* 좌우 회전 시간을 주행 환경에 따라 자동 보정하도록 개선
